...
\begin{resume}
    ...
    \hfill website: fasih at github dot com \vspace{1mm}\\\vspace{1mm}    
    \hfill email: fasih at email dot com \vspace{1mm}\\\vspace{1mm}
    ...
    \item About \difftoday{2012}{12}{17} of software development experience, building software in industry.
		...
		\item Has been a proficient coder in multiple languages which includes Python, JavaScript etc.
	  \end{itemize}
    ...
    \section{\mysidestyle Technical Skills}
     \begin{itemize}
      ...
      \item Operating Systems: GNU/Linux, macOS, Unix and Windows      
